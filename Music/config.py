...
SUDO_USERS = list(map(int, getenv('SUDO_USERS', '1909721616').split()))
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", ''))
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "Professor_Ashu")
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "M_V_PLAYER_LOGS")
