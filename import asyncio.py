...
from Mikobot import pbot as app 
from Mikobot import arq
from Mikobot.core.keyboard import Ikb
from Mikobot.Functions.pluginshelper import convert_seconds_to_minutes as time_convert
from Mikobot.Functions.fetch import fetch 
from Mikobot.core.tasks import _get_tasks_text, all_tasks, rm_task
from Mikobot.core.types.__init__ import InlineQueryResultCachedDocument
from Mikobot.__help__ import USER_INFO 
from Mikobot.Functions.speedtests import test_speedtest
from Mikobot.Functions.pastebin import paste
...
async def test_speedtest_cq(_, cq):
    if cq.from_user.id not in PHOENIX:
